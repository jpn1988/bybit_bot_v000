...
class FundingData:
    ...
    def to_tuple(self) -> tuple:
        ...
        Returns:
            tuple: (funding_rate, volume_24h, next_funding_time, spread_pct, volatility_pct)
        """
        return (
            self.funding_rate,
            self.volume_24h,
    ...
    def from_tuple(
        ...
        Args:
            ...
            data: Tuple (funding_rate, volume_24h, next_funding_time, spread_pct, volatility_pct)
