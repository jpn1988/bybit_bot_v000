...
⚠️ ARCH-001 NOTE: Ce fichier est maintenu UNIQUEMENT pour la compatibilité avec les tests.
Le code principal utilise maintenant directement les modules du package config/.
